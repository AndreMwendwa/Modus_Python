...
def dashboard_datapane_comparaison(f1, f2, f3):
    ...
    # Scénario 1
    dbfile = open(os.path.join(f1, '1_Fichiers_intermediares', 'bdinter_scen'), 'rb')
    ...
    if PPM:
        dbfile = open(os.path.join(f1, '1_Fichiers_intermediares', 'MODUSCaleUVP_df_PPM_scen'), 'rb')
    ...
    if PCJ:
        dbfile = open(os.path.join(f1, '1_Fichiers_intermediares', 'MODUSCaleUVP_df_PCJ_scen'), 'rb')
    ...
    if PPS:
        dbfile = open(os.path.join(f1, '1_Fichiers_intermediares', 'MODUSCaleUVP_df_PPS_scen'), 'rb')
